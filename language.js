(function () {
  ...
  const dictionary = {
    ...
    "能力雷达报告": "Capability Radar Report",
    "能力六边形报告": "Capability Radar Report",
    "中文": "Chinese",
    "英文": "English",
    "越南语": "Vietnamese",
    ...
    "把正式音频生成测试按研究型能力拆成 9 个维度：内容准确、自然音质、多语种、方言、音色克隆、表达控制、复杂文本/副语言、长文本稳定和 RTF 效率。综合榜按基础能力优先的权重加权：内容、音质、多语、方言和克隆占主体，表达控制作为重要控制能力，复杂副语言和 RTF 作为轻量加分/参考项；多语种轴按固定 8 个语言样本计算覆盖，避免只支持单一额外语言的项目在专项榜中被高估。": "The formal audio-generation tests are split into 9 research-oriented dimensions: content accuracy, natural audio quality, multilingual coverage, dialect coverage, voice cloning, expressive control, complex text/paralinguistics, long-form stability, and RTF efficiency. The overall ranking uses foundation-first weights: content, audio quality, multilingual coverage, dialect coverage, and cloning carry the main weight; expressive control is an important control capability; complex paralinguistics and RTF remain light bonus/reference axes. The multilingual axis uses a fixed 8-language sample set, so a project that supports only one extra language is not overestimated in the specialty ranking.",
    ...
    "专项榜只比较进入该能力轴的项目，综合榜仍按 9 轴全能覆盖加权。": "Specialty rankings only compare projects that enter that capability axis; the overall ranking is still weighted across the 9-axis capability coverage.",
    "全部项目": "All Projects",
    ...
    "多语种能力": "Multilingual Capability",
    "方言能力": "Dialect Capability",
    "多语种": "Multilingual",
    "方言": "Dialect",
