...
- Source run: `vietnamese_clone_deep_compare_20260516_110254`
- Cloning reference: `/Users/vanch/VideoLingo-plus/core/all_tts_functions/voice/Bạn khỏe không .m4a`
- Published normalized reference WAV: [ban_khoe_khong_ref_24k.wav](../audio/reference/ban_khoe_khong_ref_24k.wav)
...
This is the capability report. The GitHub Pages publication keeps only the final listening-report audio versions. Use the [listening report](listening-report.md) for playable audio.
...
- Summary CSV: [capability-summary.csv](capability-summary.csv)
- Row metrics CSV: [capability-row-metrics.csv](capability-row-metrics.csv)
- MLX ASR JSON files remain in the local benchmark archive and are not part of the GitHub Pages publish set.
