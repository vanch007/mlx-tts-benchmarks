...
| P1 | `axis_quality_low` | 自然度与音频质量 |  | 55.472 | axis quality score below 70 with sufficient coverage | inspect low-scoring cases inside this axis and retest with parameter/code fixes |
