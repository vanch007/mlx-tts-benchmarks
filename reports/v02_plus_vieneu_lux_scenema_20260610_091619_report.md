...
| 2 | `mlx_higgs_audio` | 32 | 81.862 | 88.889 | 91.049 | 75.631 | 92.49 | 0.0 | 82.15 | 89.961 | 91.68 | 89.025 | 39.957 | yes |
| 3 | `mlx_voxcpm2` | 36 | 81.597 | 100.0 | 92.553 | 64.238 | 91.678 | 87.882 | 80.824 | 90.781 | 74.349 | 88.349 | 40.742 | yes |
| 4 | `mlx_omnivoice` | 30 | 79.504 | 98.611 | 90.807 | 65.477 | 79.742 | 87.689 | 80.044 | 82.665 | 93.791 | 83.905 | 43.833 | yes |
| 5 | `mlx_qwen3_tts` | 23 | 79.348 | 84.722 | 90.145 | 74.248 | 55.235 | 88.04 | 88.919 | 91.148 | 0.0 | 91.673 | 79.776 | yes |
| 6 | `mlx_dots_tts` | 27 | 77.093 | 88.889 | 86.231 | 64.136 | 89.343 | 82.29 | 80.68 | 88.913 | 0.0 | 86.383 | 43.632 | yes |
...
| 9 | `mlx_ming_omni_tts` | 19 | 64.225 | 88.889 | 83.197 | 51.772 | 0.0 | 90.337 | 79.261 | 89.906 | 84.075 | 76.816 | 16.579 | yes |
...
| `mlx_indextts2_standard_8bit` | 中文参考音色克隆 (clone_zh_same) | success | qwen3_asr_1_7b_8bit | 0.0 | 0.9063 | 2.6699 | 1.7976 |  |
| `mlx_indextts2_standard_8bit` | 三秒英文短参考音色克隆 (clone_3s_en) | success | qwen3_asr_1_7b_8bit | 0.0 | 0.8141 | 4.3319 | 2.0326 |  |
| `mlx_indextts2_standard_8bit` | 英文参考音色说中文克隆 (xling_en_to_zh) | success | qwen3_asr_1_7b_8bit | 0.0 | 0.8165 | 3.4407 | 2.1944 |  |
...
| `mlx_ming_omni_tts_16_8b_a3b_bf16` | 中文近讲 ASMR 女声音色设计 (control_voice_design_asmr) | success | qwen3_asr_1_7b_8bit | 0.0 |  | 2.0445 | 2.2803 |  |
...
| `mlx_indextts2_standard_8bit` | 英文表演式参考音色克隆 (scenema_clone_tarkin_en) | success | qwen3_asr_1_7b_8bit | 0.0 | 0.9193 | 3.7261 | 2.2212 |  |
...
| `mlx_indextts2_standard_8bit` | 中英混读品牌与订单号朗读 (core_zh_en_codeswitch) | success | qwen3_asr_1_7b_8bit | 0.0 | 0.9171 | 2.5448 | 1.7823 |  |
