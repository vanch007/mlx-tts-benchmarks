...
- Text: `/Users/vanch/tts_benchmarks/vietnamese_ref_compare_20260516_104409/input_text_vi.txt`
- Reference audio original: `/Users/vanch/VideoLingo-plus/core/all_tts_functions/voice/Bạn khỏe không .m4a`
- Reference audio normalized WAV: `/Users/vanch/tts_benchmarks/vietnamese_ref_compare_20260516_104409/ref/ban_khoe_khong_ref_24k.wav`
...
|---|---:|---:|---:|---:|---:|---|---|
| Supertonic 3 preset F1 | False | 100.177s | 15.801s | 0.1577 | 0.8142 | `/Users/vanch/tts_benchmarks/vietnamese_ref_compare_20260516_104409/supertonic/supertonic_F1_vi_long.wav` | 固定音色；不使用参考音频克隆 |
| IndexTTS2 Vietnamese 8bit | True | 80.132s | 58.807s | 0.7339 | 0.7859 | `/Users/vanch/tts_benchmarks/vietnamese_ref_compare_20260516_104409/indextts2_vi/indextts2_vi_ref_long.wav` | 使用参考音频克隆；越南语专用模型 |
| Qwen3-TTS Base int8 | True | 54.560s | 19.190s | 0.3517 | 0.7202 | `/Users/vanch/tts_benchmarks/vietnamese_ref_compare_20260516_104409/qwen3_tts/qwen3_tts_vi_ref_long.wav` | 使用参考音频+ref_text ICL；lang-code=vi |
| OmniVoice 8bit | True | 110.221s | 40.508s | 0.3675 | 0.7548 | `/Users/vanch/tts_benchmarks/vietnamese_ref_compare_20260516_104409/omnivoice/omnivoice_vi_ref_long.wav` | 使用参考音频+ref_text；实验性越南语对比 |
